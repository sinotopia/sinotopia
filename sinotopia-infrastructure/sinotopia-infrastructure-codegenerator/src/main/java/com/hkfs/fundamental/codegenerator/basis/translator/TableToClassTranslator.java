...
public class TableToClassTranslator {
	 ...
	 * 设置父类
	 */
	public TableToClassTranslator setParentClass(Class parentClass) {
	 ...
	 * @return 转换后的Class数组
	 */
	public Class[] translate(Table[] tables) {
		List<Class> classList = new ArrayList<Class>(tables.length);
