...
public class AppendUtils {
	...
	public static String processClassImports(com.hkfs.fundamental.codegenerator.basis.data.Class[] classes) {
		StringBuilder sb = new StringBuilder();
	...
	public static String processParentClassImport(Class parentClass) {
