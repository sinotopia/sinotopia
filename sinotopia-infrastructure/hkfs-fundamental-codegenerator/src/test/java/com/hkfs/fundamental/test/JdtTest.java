...
public class JdtTest {
    ...
    private static void testFile() {
        ...
        String path = "F:\\works\\crawler\\crawler-system\\crawler-system\\crawler-api\\src\\main\\java\\com\\hakim\\crawler\\params\\SubmitPbccrcAnswerParameter.java";

        com.hkfs.fundamental.codegenerator.basis.data.Class cls = null;
