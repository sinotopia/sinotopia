...
public class StrUtils {
     ...
     * @return
     */
    public static String replaceText(String template, Map<String, Object> replacement) {
...
//		chinaMobileSet.add("188");
    ...
    public static <T extends Object> String appendUrlParameters(String url, Map<String, T> params, boolean cover) {
        ...
        while (newParamsIterator.hasNext()) {
            ...
            existingParamsMap.put(key, value.toString());
        }
    ...
    public static String trimQuotation(String text) {
        String content = getMiddleText(text, DOUBLE_QUOTATION, DOUBLE_QUOTATION, true, false);
        if (content != null) {
            return trim(content);
        }
        return trim(text);
