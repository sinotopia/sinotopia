...
public abstract class ValidateFilter<T> {
    ...
    private T resolveParams(final Map<String, Object> paramsMap) {
        ...
        try {
            ...
            ReflectionUtils.doWithFields(this.clazz, new ReflectionUtils.FieldCallback() {
                ...
                public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
                    if (!paramsMap.containsKey(field.getName())) {
                        throw new com.sinotopia.fundamental.exception.ApplicationBizException(ValidateRetCode.FILTER_PARAM_ERROR.getCode(), ValidateRetCode.FILTER_PARAM_ERROR.getDescription() + "[" + ValidateFilter.this.clazz.getName()+ "->" + field.getName() + "]");
                    }
                }
            });
            ...
            throw new com.sinotopia.fundamental.exception.ApplicationBizException(ValidateRetCode.FILTER_ERROR.getCode(), ValidateRetCode.FILTER_ERROR.getDescription());
