 ...
 * @Date 2016/7/11
 */
public class SinotopiaTomcatCustomizerBeanPostProcessor implements BeanPostProcessor, ApplicationContextAware {

    private final static Logger LOGGER = LoggerFactory.getLogger(SinotopiaTomcatCustomizerBeanPostProcessor.class);
    ...
    private void postProcessBeforeInitialization(
        ...
        LOGGER.info("**********************sinotopiaTomcatConnectorCustomizers length = {} ,begin to set Tomcat Connector Customizer …… ",getTomcatConnectorCustomizers().size());
        bean.setTomcatConnectorCustomizers(getTomcatConnectorCustomizers());

        //这里处理自动添加一下TomcatContextCustomizer
        LOGGER.info("**********************sinotopiaTomcatContextCustomizers length = {} ,begin to set Tomcat Context Customizer …… ",getTomcatContextCustomizers().size());
