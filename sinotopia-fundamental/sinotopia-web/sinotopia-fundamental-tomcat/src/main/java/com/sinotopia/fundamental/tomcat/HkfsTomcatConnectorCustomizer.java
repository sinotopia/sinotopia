...
import com.hkfs.fundamental.tomcat.constants.TomcatConstants;
 ...
 * @Date 2016/7/8
 */
public class HkfsTomcatConnectorCustomizer implements TomcatConnectorCustomizer {
    private final static Logger LOGGER = LoggerFactory.getLogger(HkfsTomcatConnectorCustomizer.class);
    @Override
    public void customize(Connector connector) {
        LOGGER.info("**********************Hkfs Tomcat Connector config begin ......");
        //对tomcat的相关参数进行优化
        ...
        if (handler instanceof AbstractHttp11Protocol) {
            ...
            LOGGER.info("**********************Hkfs Tomcat Connector config finished!");
        }
    }
}
