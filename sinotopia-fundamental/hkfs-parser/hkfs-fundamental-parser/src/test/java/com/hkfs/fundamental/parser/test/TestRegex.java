...
//                        new ParserWrap(data, DefineLoader.getFieldDefine(TestRegex.class.getResourceAsStream("/parser.xml"), "bookParser-regex-part1")),
//                        new ParserWrap(data2, DefineLoader.getFieldDefine(TestRegex.class.getResourceAsStream("/parser.xml"), "bookParser-html-part2")),
                    },
                    TestObject.class);
