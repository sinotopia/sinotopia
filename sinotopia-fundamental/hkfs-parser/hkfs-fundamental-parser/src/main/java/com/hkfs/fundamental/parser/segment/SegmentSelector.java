...
//    整个表达式的前面以空格开头表示相对表达式
    ...
    public static boolean isSegmentSelector(String selector) {
    ...
    public static String matcher(String html, String childText, String selector) {
        ...
        return SubStrUtils.getMiddleText(text, prefixSuffixList.toArray(new PrefixSuffix[prefixSuffixList.size()]));
    }
