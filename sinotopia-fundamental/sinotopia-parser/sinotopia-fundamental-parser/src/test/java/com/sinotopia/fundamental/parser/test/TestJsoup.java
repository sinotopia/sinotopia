...
//                        new ParserWrap(data2, getFieldDefine2()),
                        new ParserWrap(data, DefineLoader.getFieldDefine(TestJsoup.class.getResourceAsStream("/parser.xml"), "bookParser-html-part1")),
                        new ParserWrap(data2, DefineLoader.getFieldDefine(TestJsoup.class.getResourceAsStream("/parser.xml"), "bookParser-html-part2")),
                },
                TestObject.class);
