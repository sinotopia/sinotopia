 ...
 * Created by zhoubing on 2016/10/11.
 */
...
//    private final Log log = LogFactory.getLog(getClass());
    ...
    public static HostnameVerifier getDefaultHostnameVerifier() {
        return ALLOW_ALL_HOSTNAME_VERIFIER;//默认信任策略为信任全部
    }
    ...
    /**
     * @deprecated (4.4) Use {@link #CoreSSLConnectionSocketFactory(javax.net.ssl.SSLContext,
     ...
     * @throws java.io.IOException may be thrown if overridden
     */
