...
@ComponentScan(basePackages = {"com.djd", "com.hakim", "com.dyc"}, excludeFilters = {@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = QuickWebBootstrap.class)})
