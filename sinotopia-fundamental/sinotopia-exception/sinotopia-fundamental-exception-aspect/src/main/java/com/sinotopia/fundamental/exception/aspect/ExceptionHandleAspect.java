package com.sinotopia.fundamental.exception.aspect;

import com.alibaba.fastjson.JSON;
import com.sinotopia.fundamental.api.data.Result;
import com.sinotopia.fundamental.api.enums.ResultCode;
import com.sinotopia.fundamental.exception.ApplicationBizException;
...
public class ExceptionHandleAspect {
    ...
    public Object handleException(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            return handleMethodReturnType(returnType, ResultCode.COMMON_ERROR.getCode(), ResultCode.COMMON_ERROR.getDescription(), e);
        }
        return result;
    }
