package com.sinotopia.wechat.mp.dao;

import com.sinotopia.common.util.MybatisGeneratorUtil;
...
public class Generator {
    ...
    // 根据命名规范，只修改此常量值即可
    private static String MODULE = "sinotopia-wechat-mp";
    private static String DATABASE = "sinotopia";
    private static String TABLE_PREFIX = "wechat_mp_";
    private static String PACKAGE_NAME = "com.sinotopia.wechat.mp";
