...
<div id="main">
    <div id="toolbar">
        <shiro:hasPermission name="cms:page:create"><a class="waves-effect waves-button" href="javascript:;"
                                                       onclick="createAction()"><i class="zmdi zmdi-plus"></i>
            新增单页</a></shiro:hasPermission>
        <shiro:hasPermission name="cms:page:update"><a class="waves-effect waves-button" href="javascript:;"
                                                       onclick="updateAction()"><i class="zmdi zmdi-edit"></i>
            编辑单页</a></shiro:hasPermission>
        <shiro:hasPermission name="cms:page:delete"><a class="waves-effect waves-button" href="javascript:;"
                                                       onclick="deleteAction()"><i class="zmdi zmdi-close"></i>
            删除单页</a></shiro:hasPermission>
    </div>
