...
<div>
    <form method="post">
        <table border="1">
            ...
            <tr>
                <td>楼中楼编号：</td>
                <td><input type="text" name="pid" value="${comment.pid}"/></td>
            </tr>
            <tr>
                <td>所属系统：</td>
                <td><input type="text" name="systemId" value="${comment.systemId}"/></td>
            </tr>
            <tr>
                <td>文章编号：</td>
                <td><input type="text" name="articleId" value="${comment.articleId}"/></td>
            </tr>
            <tr>
                <td>用户编号：</td>
            ...
            <tr>
                <td>IP地址：</td>
                <td><input type="text" name="ip" value="${comment.ip}"/></td>
            </tr>
            <tr>
                <td>终端信息：</td>
                <td><input type="text" name="agent" value="${comment.agent}"/></td>
            </tr>
            <tr>
                <td></td>
                <td><a href="${basePath}/manage/comment/list">取消</a>　<input type="submit" value="保存"/></td>
            </tr>
        </table>
    </form>
</div>
