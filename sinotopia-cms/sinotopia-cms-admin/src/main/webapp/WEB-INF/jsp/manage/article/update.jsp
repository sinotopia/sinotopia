    ...
    <form id="updateForm" method="post">
        ...
        <div class="row">
                    ...
                    <div class="fg-line">
                        <select id="topicId" name="topicId" style="width: 100%">
                            ...
                            <c:forEach var="cmsTopic" items="${cmsTopics}">
                                <option value="${cmsTopic.topicId}"
                                        <c:if test="${article.topicId==cmsTopic.topicId}">selected</c:if>>${cmsTopic.title}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="radio">
                    <div class="radio radio-inline radio-info">
                        <input id="allowcomments_1" type="radio" name="allowcomments" value="1"
                               <c:if test="${article.allowcomments==1}">checked</c:if>>
                        <label for="allowcomments_1">允许 </label>
                    </div>
                    <div class="radio radio-inline radio-danger">
                        <input id="allowcomments_0" type="radio" name="allowcomments" value="0"
                               <c:if test="${article.allowcomments==0}">checked</c:if>>
                ...
                <div class="radio">
                    ...
                    <div class="radio radio-inline radio-info">
                        <input id="status_0" type="radio" name="status" value="0"
                               <c:if test="${article.status==0}">checked</c:if>>
