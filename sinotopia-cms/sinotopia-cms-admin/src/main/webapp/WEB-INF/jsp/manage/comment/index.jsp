...
<div id="main">
    <div id="toolbar">
        <shiro:hasPermission name="cms:comment:delete"><a class="waves-effect waves-button" href="javascript:;"
                                                          onclick="deleteAction()"><i class="zmdi zmdi-close"></i> 删除评论</a></shiro:hasPermission>
    </div>
