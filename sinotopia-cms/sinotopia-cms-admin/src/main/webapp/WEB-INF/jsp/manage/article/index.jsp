...
<div id="main">
    <div id="toolbar">
        <shiro:hasPermission name="cms:article:create"><a class="waves-effect waves-button" href="javascript:;"
                                                          onclick="createAction()"><i class="zmdi zmdi-plus"></i>
            新增文章</a></shiro:hasPermission>
        <shiro:hasPermission name="cms:article:update"><a class="waves-effect waves-button" href="javascript:;"
                                                          onclick="updateAction()"><i class="zmdi zmdi-edit"></i>
            编辑文章</a></shiro:hasPermission>
        <shiro:hasPermission name="cms:article:delete"><a class="waves-effect waves-button" href="javascript:;"
                                                          onclick="deleteAction()"><i class="zmdi zmdi-close"></i> 删除文章</a></shiro:hasPermission>
    </div>
