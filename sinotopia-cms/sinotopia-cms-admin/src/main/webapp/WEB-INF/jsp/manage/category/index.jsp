...
<div id="main">
    <div id="toolbar">
        <shiro:hasPermission name="cms:category:create"><a class="waves-effect waves-button" href="javascript:;"
                                                           onclick="createAction()"><i class="zmdi zmdi-plus"></i> 新增类目</a></shiro:hasPermission>
        <shiro:hasPermission name="cms:category:update"><a class="waves-effect waves-button" href="javascript:;"
                                                           onclick="updateAction()"><i class="zmdi zmdi-edit"></i> 编辑类目</a></shiro:hasPermission>
        <shiro:hasPermission name="cms:category:delete"><a class="waves-effect waves-button" href="javascript:;"
                                                           onclick="deleteAction()"><i class="zmdi zmdi-close"></i> 删除类目</a></shiro:hasPermission>
    </div>
